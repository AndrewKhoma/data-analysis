...
![plt-1](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-1.png)

```R
corrplot(M, method = "square")
```

![plt-2](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-2.png)

```R
corrplot(M, method = "ellipse")
```

![plt-3](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-3.png)

```R
corrplot(M, method = "number") # Display the correlation coefficient
```

![plt-4](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-4.png)

```R
corrplot(M, method = "shade")
```

![plt-5](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-5.png)

```R
corrplot(M, method = "color")
```

![plt-6](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-6.png)

```R
corrplot(M, method = "pie")
```

![plt-7](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-7.png)
...
![plt-8](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-8.png)
...
![plt-9](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-9.png)

```R
corrplot.mixed(M, lower.col = "black", number.cex = .7)
```

![plt-10](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-10.png)

```R
corrplot.mixed(M, lower = "ellipse", upper = "circle")
```

![plt-11](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-11.png)

```R
corrplot.mixed(M, lower = "square", upper = "circle", tl.col = "black")
```

![plt-12](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-12.png)
...
![plt-13](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-13.png)

```R
corrplot(M, order = "hclust")
```

![plt-14](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-14.png)

```R
corrplot(M, order = "FPC")
```

![plt-15](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-15.png)

```R
corrplot(M, order = "alphabet")
```

![plt-16](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-16.png)
...
![plt-17](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-17.png)

```R
corrplot(M, order = "hclust", addrect = 3)
```

![plt-18](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-18.png)
...
![plt-19](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-19.png)
...
![plt-20](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-20.png)

```R
corrplot(M, order = "hclust", addrect = 2, col = col2(50))
```

![plt-21](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-21.png)

```R
corrplot(M, order = "hclust", addrect = 2, col = col3(20))
```

![plt-22](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-22.png)

```R
corrplot(M, order = "hclust", addrect = 2, col = col4(10))
```

![plt-23](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-23.png)

```R
corrplot(M, order = "hclust", addrect = 2, col = whiteblack, bg = "gold2")
```

![plt-24](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-24.png)
...
![plt-25](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-25.png)

```R
corrplot(M, order = "hclust", addrect = 2, col = terrain.colors(100))
```

![plt-26](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-26.png)

```R
corrplot(M, order = "hclust", addrect = 2, col = cm.colors(100))
```

![plt-27](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-27.png)

```R
corrplot(M, order = "hclust", addrect = 2, col = gray.colors(100))
```

![plt-28](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-28.png)
...
![plt-29](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-29.png)

```R
corrplot(M, type = "upper", order = "hclust", col = brewer.pal(n = 8, name = "RdYlBu"))
```

![plt-30](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-30.png)

```R
corrplot(M, type = "upper", order = "hclust", col = brewer.pal(n = 8, name = "PuOr"))
```

![plt-31](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-31.png)
...
![plt-32](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-32.png)
...
![plt-33](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-33.png)
...
![plt-34](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-34.png)
...
![plt-35](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-35.png)
...
![plt-36](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-36.png)
...
![plt-37](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-37.png)
...
![plt-38](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-38.png)
...
![plt-39](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-39.png)
...
![plt-40](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-40.png)

```R
corrplot(M2, na.label = "o")
```

![plt-41](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-41.png)

```R
corrplot(M2, na.label = "NA")
```

![plt-42](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-42.png)
...
![plt-43](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-43.png)
...
![plt-44](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-44.png)

```R
corrplot(M, p.mat = res1$p, sig.level = .05)
```

![plt-45](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-45.png)

```R
corrplot(M, p.mat = res1$p, sig.level = .01)
```

![plt-46](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-46.png)
...
![plt-47](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-47.png)
...
![plt-48](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-48.png)
...
![plt-49](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-49.png)
...
![plt-50](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-50.png)
...
![plt-51](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-51.png)
...
![plt-52](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-52.png)
...
![plt-54](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-54.png)

```R
corrplot(M, p.mat = res1$p, method = "color", type = "upper", sig.level = c(.001, .01, .05), pch.cex = .9, insig = "label_sig", pch.col = "white", order = "AOE")
```

![plt-55](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-55.png)

```R
corrplot(M, p.mat = res1$p, insig = "label_sig", pch.col = "white", pch = "p<.05", pch.cex = .5, order = "AOE")
```

![plt-56](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-56.png)
...
![plt-57](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-57.png)
...
![plt-58](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-58.png)
...
![plt-59](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-59.png)
...
![plt-60](https://github.com/Sky-Nik/data-analysis/labs/lab-2/plt-60.png)
